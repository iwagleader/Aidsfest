...
if ((player distance ((INV_Lizenzen select _i) select 1) <= 5) and !(_license call INV_HasLicense) and (_added == 0)) then 
...
if ((player distance ((INV_Lizenzen select _i) select 1) > 5) and (_added == 1) || (_license call INV_HasLicense)) then 
