...
if ("K9_license" call INV_HasLicense) then 
	...
	_income = _income + (500 + random 500 - random 500);
...
if ("PDAviation_license" call INV_HasLicense) then 
	...
	_income = _income + (1000 + random 1000 - random 1000);
...
if ("SWAT_license" call INV_HasLicense) then 
	...
	_income = _income + (1500 + random 1500 - random 1500);
...

{
	...
	_income = _income + (10000 + random 1500 - random 1500);
...

{
	...
	_income = _income + (50000 + random 1500 - random 1500);
