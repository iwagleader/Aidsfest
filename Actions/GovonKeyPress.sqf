...

{
	...
	if(INV_shortcuts)then{INV_shortcuts=false; titletext["RL keys off", "PLAIN DOWN"];[] execVM "actions\actionsRemove.sqs"}else{INV_shortcuts=true; titletext["RL keys on", "PLAIN DOWN"];[] execVM "actions\govactions.sqf"};};
	//L key
	case 38: 
