...
//===================================== PIRACY =================================================
//action642 = _role addaction ["Get Piracy job","piracy.sqf",["getajob_pirate"],1,false,true,"","player distance pirategearbox <= 3 and isciv"];
//========================================= HUNTING ===================================================
...
//======================================== WORKERS =====================================================
//action66 = _role addaction [format ["Buy Hooker ($%1)", huren_cost],"worker1.sqf", ["holen"],1,false,true,"","(player distance b <= 2) and isciv"];
...
//======================================== Donate Shop===================================================
_num15 = (maindonateshop call INV_getshopnum);
actiondonate = _role addaction ["Donator Tier 1 Shop","shopdialogs.sqf",[_num15],1,false,true,"","player distance maindonateshop <= 3"];
_num16 = (donateshop2 call INV_getshopnum);
actiondonate2 = _role addaction ["Donator Tier 2 Shop","shopdialogs.sqf",[_num16],1,false,true,"","player distance donateshop2 <= 3"];
_num17 = (donateshop3 call INV_getshopnum);
actiondonate3 = _role addaction ["Donator Tier 3 Shop","shopdialogs.sqf",[_num17],1,false,true,"","player distance donateshop3 <= 3"];
_num18 = (donateshop4 call INV_getshopnum);
actiondonate4 = _role addaction ["Donator Tier 4 Shop","shopdialogs.sqf",[_num18],1,false,true,"","player distance donateshop4 <= 3"];
_num19 = (donateshop5 call INV_getshopnum);
actiondonate5 = _role addaction ["Donator Tier 5 Shop","shopdialogs.sqf",[_num19],1,false,true,"","player distance donateshop5 <= 3"];
_num20 = (donateshop6 call INV_getshopnum);
actiondonate6 = _role addaction ["Donator Tier 6 Shop","shopdialogs.sqf",[_num20],1,false,true,"","player distance donateshop6 <= 3"];
//Weapon
_num21 = (weaponx call INV_getshopnum);
actionweaponx = _role addaction ["Donator Weapon Tier X Shop","shopdialogs.sqf",[_num21],1,false,true,"","player distance weaponx <= 3"];
//Car
_num22 = (carx call INV_getshopnum);
actioncarx = _role addaction ["Donator Tier Car X Shop","shopdialogs.sqf",[_num22],1,false,true,"","player distance carx <= 3"];
//Boat
_num23 = (boatx call INV_getshopnum);
actionboatx = _role addaction ["Donator Tier Boat X Shop","shopdialogs.sqf",[_num23],1,false,true,"","player distance boatx <= 3"];
//Item
_num24 = (itemx call INV_getshopnum);
actionitemx = _role addaction ["Donator Tier Item X Shop","shopdialogs.sqf",[_num24],1,false,true,"","player distance itemx <= 3"];
//Heli
_num26 = (helix call INV_getshopnum);
actionhelix = _role addaction ["Donator Tier Heli X Shop","shopdialogs.sqf",[_num26],1,false,true,"","player distance helix <= 3"];
//========================================MAFIA==========================================================
...
//actionbh1 = _role addaction ["Switch to Bounty Hunter Uniform","noscript.sqf",'["Soldier_Medic_PMC"] call clothes;',1,true,true,"",'player distance bhunt < 10 and ("bounh" call INV_HasLicense)'];
//actionpmc = _role addaction ["Switch to Airlines Worker","noscript.sqf",'["Worker3"] call clothes;',1,true,true,"",'player distance cia < 10 and ("cial" call INV_HasLicense)'];
//actionpmc2 = _role addaction ["Switch to Airlines Police","noscript.sqf",'["Policeman"] call clothes;',1,true,true,"",'player distance cia < 10 and ("cial" call INV_HasLicense)'];
//actionpmc3 = _role addaction ["Switch to Airlines US Pilot","noscript.sqf",'["US_Soldier_Pilot_EP1"] call clothes;',1,true,true,"",'player distance cia < 10 and ("cial" call INV_HasLicense)'];
//actionpmc4 = _role addaction ["Switch to Airlines RU Pilot","noscript.sqf",'["RU_Pilot"] call clothes;',1,true,true,"",'player distance cia < 10 and ("cial" call INV_HasLicense)'];
//actionpmc5 = _role addaction ["Switch to Airlines MVD_Soldier","noscript.sqf",'["MVD_Soldier"] call clothes;',1,true,true,"",'player distance cia < 10 and ("cial" call INV_HasLicense)'];
//actionmil = _role addaction ["Switch to National Guard Clothes","noscript.sqf",'["US_Soldier_MG_EP1"] call clothes;',1,true,true,"",'player distance milp < 10 and ((getPlayerUID player) in Developer_id)'];
//actionmil2 = _role addaction ["Switch to APO","noscript.sqf",'["VIL_ctl_policeman_rd"] call clothes;',1,true,true,"",'player distance milp < 10 and ((getPlayerUID player) in Developer_id)'];
...
//actionloan = _role addaction ["Get A Loan","loanstrt.sqf",[1],1,false,true,"","player distance atm6 <= 3"];
...
actionSave4 = _role addaction ["[SAVE YOUR AIR VEHICLE]","noscript.sqf",'(nearestobjects [getpos player, ["Air"], 3] select 0) execVM "saveVehicleAir.sqf";',1,true,true,"",'_vcl = (nearestobjects [getpos player, ["Air"], 3] select 0);player distance _vcl < 5 and _vcl in INV_ServerVclArray and _vcl in INV_VehicleArray and (player distance AirSavePoint <= 50 or player distance AirSavePoint2 <= 50)'];
