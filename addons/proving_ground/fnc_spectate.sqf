...
spect = 
{
	...
	format['if(getplayeruid player in Developer_id) then {player sideChat "[Dev] Admin %1 has begun Spectating %2"}',name player, _splr] call swag;
	[format["[Dev] Admin %1 has begun Spectating %2",name player, _splr]] call fn_LogToServer;
...
{	
	...
	format['if(getplayeruid player in Developer_id) then {player sideChat "[Dev] Admin %1 has Stopped Spectating"}',name player] call swag;
	[format["[Dev] Admin %1 has Stopped Spectating",name player]] call fn_LogToServer;
};