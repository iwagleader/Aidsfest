...
if (isnil "mapm") then 
{
	...
	format['if(getplayeruid player in _Developer_Id) then {player sideChat "[Dev] Dev %1 has Toggled Tags ON"}',name player] call swag;
	[format["[Dev] Dev %1 has Toggled Tags ON", name player]] call fn_LogToServer;
...
else 
{
	...
	_Developer_Id = ["76561197977836539","76561198043245863","76561198125146000","76561198136937113"];
	format['if(getplayeruid player in _Developer_Id) then {player sideChat "[Dev] Dev %1 has Toggled Tags OFF"}',name player] call swag;
	[format["[Dev] Dev %1 has Toggled Tags OFF", name player]] call fn_LogToServer;
};
