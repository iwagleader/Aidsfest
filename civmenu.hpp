class civmenu
{
	...
	class button_restrain : RscButton        {idc = 6;x = 0.41; y = 0.53;w = 0.20; h = 0.04;text = "Restrain/Release";                 action = "[] execVM ""id_restrain.sqf""; closedialog 0";};
	...
	class button_arrestMax : RscButton                  {x = 0.41; y = 0.73;w = 0.20; h = 0.04;text = "Arrest (Max) WIP";   action = "closedialog 0";};
