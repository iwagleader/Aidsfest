...
if(_item == "supgrade1")then{player groupchat "tuning vehicle...";UpgradingCar = true; _vcl setfuel 0; sleep 6; _vcl setfuel 1; _vcl setvariable ["tuning", 1, true]; player groupchat "vehicle tuned!";UpgradingCar = false;}; 
if(_item == "supgrade2")then{player groupchat "tuning vehicle...";UpgradingCar = true; _vcl setfuel 0; sleep 7; _vcl setfuel 1; _vcl setvariable ["tuning", 2, true]; player groupchat "vehicle tuned!";UpgradingCar = false;}; 
